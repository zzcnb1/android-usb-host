...
public class Draw_Cha1 extends SurfaceView implements SurfaceHolder.Callback{
		...
		public Draw_Cha1(Context context)
		{
			super(context);
		...
		public Draw_Cha1(Context context, AttributeSet attrs)
		{
			super(context, attrs);
			holder=this.getHolder();
		    holder.addCallback(this);
