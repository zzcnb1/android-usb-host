...
public class Draw_first extends SurfaceView implements SurfaceHolder.Callback
{
	...
	public Draw_first(Context context)
	{
		super(context);
	...
	public Draw_first(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		holder=this.getHolder();
	    holder.addCallback(this);
