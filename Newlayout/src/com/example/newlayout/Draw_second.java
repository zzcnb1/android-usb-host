...
public class Draw_second extends SurfaceView implements SurfaceHolder.Callback{
	 ...
	 private RefreshThread thread;
		public Draw_second(Context context)
		{
			super(context);
		...
		public Draw_second(Context context, AttributeSet attrs)
		{
			super(context, attrs);
			holder=this.getHolder();
		    holder.addCallback(this);
		...
		{	
			...
			DrawData(Data_RW.CHAlist2,canvas);
			
		}
	    
		private void DrawData(ArrayList<Integer> data,Canvas canvas) 
		{
