...
public class Draw_Cha4 extends SurfaceView implements SurfaceHolder.Callback{
	 private int unitX,unitY;
		...
		public Draw_Cha4(Context context)
		{
			super(context);
		...
		public Draw_Cha4(Context context, AttributeSet attrs)
		{
			super(context, attrs);
			holder=this.getHolder();
		    holder.addCallback(this);
