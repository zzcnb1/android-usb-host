...
public class Draw_Cha2 extends SurfaceView implements SurfaceHolder.Callback{
		...
		public Draw_Cha2(Context context)
		{
			super(context);
		...
		public Draw_Cha2(Context context, AttributeSet attrs)
		{
			super(context, attrs);
			holder=this.getHolder();
		    holder.addCallback(this);
