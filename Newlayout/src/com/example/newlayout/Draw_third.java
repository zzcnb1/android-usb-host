...
public class Draw_third extends SurfaceView implements SurfaceHolder.Callback{
	 private int unitX,unitY;
		...
		public Draw_third(Context context)
		{
			super(context);
		...
		public Draw_third(Context context, AttributeSet attrs)
		{
			super(context, attrs);
			holder=this.getHolder();
		    holder.addCallback(this);
		...
		{	
			...
			DrawData(Data_RW.CHAlist3,canvas);
